<template>
  <div class="p-4 record">
    ...
    <form class="">
      ...
      <p>
        <label>
          <input class="" name="type" type="radio" value="income" />
          <span>Доход</span>
        </label>
      </p>
      <p>
        <label>
          <input class="" name="type" type="radio" value="outcome" />
          <span>Расход</span>
        </label>
      </p>
      ...
      <div class="mt-4">
        <button type="submit" class="btn btn-info shadow-sm rounded ">
